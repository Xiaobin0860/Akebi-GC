...
// EvtCrash
DO_APP_FUNC(0x02945250, void, MoleMole_EvtCrash_Init, (EvtCrash* __this, uint32_t targetID, MethodInfo* method));
...
DO_APP_FUNC(0x03636BA0, void, Formula_CalcHitHaltTime, (BaseEntity* attackeeEntity, AttackResult* attackResult, MethodInfo* method));
DO_APP_FUNC(0x03639000, int32_t, MoleMole_Formula_GenerateCriticHash, (uint32_t attackerRuntimeID, uint32_t attackeeRuntimeID, uint32_t timeStamp, Vector3 hitPosition, uint32_t attenuationCound, MethodInfo* method));
DO_APP_FUNC(0x03636D20, uint32_t, Formula_GenerateRandomNumber, (uint32_t seed, uint32_t range, MethodInfo* method));
DO_APP_FUNC(0x03636880, uint32_t, Formula_XorShiftRNG32, (uint32_t seed, MethodInfo* method));
...
DO_APP_FUNC(0x05C3E630, GameObject*, GameObject_CreatePrimitive, (PrimitiveType__Enum type, MethodInfo* method));
...
// LocalEntityInfoData
DO_APP_FUNC(0x0341E280, Vector3, MoleMole_LocalEntityInfoData_get_initPos, (LocalEntityInfoData* __this, MethodInfo* method));
...
DO_APP_FUNC(0x025A4330, void, ProfileEditPage, (MonoFriendInformationDialog* __this, Sprite* value, MethodInfo* method));
...
DO_APP_FUNC(0x029A5DE0, Button_1*, ProfilePage, (MonoInLevelPlayerProfilePage* __this, MethodInfo* method));
...
DO_APP_FUNC(0x0089FAD0, void, MoleMole_VCMonsterAIController_TryDoSkill, (/* VCMonsterAIController */ void* __this, uint32_t skillID, MethodInfo* method));
