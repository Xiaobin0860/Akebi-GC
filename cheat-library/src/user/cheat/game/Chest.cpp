...
namespace cheat::game
{
	...
	cheat::game::Chest::ItemType Chest::itemType()
	{
		...
		else if (name().find("Search") != std::string::npos || name().find("JunkChest") != std::string::npos || name().find("SumeruCrudeChest") != std::string::npos || name().find("DesertCrudeChest") != std::string::npos)
